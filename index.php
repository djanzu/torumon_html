...
<body>
  <header class="header">
    ...
    <div class="container">
      <nav class="nav is-pc">
        <ul class="pages flex">
          ...
          <li class="page handle">
            <a href="/handle/" class="link">操作方法</a>
          </li>
          ...
          <li class="page facebook">
            <a href="/contact/" class="link facebook"><img class="icon" src="assets/img/facebook.png"
                alt="Facebook"></a>
          </li>
        </ul>
      </nav>
      <div class="main-menu flex">
        <div class="left flex">
          ...
          <div class="account">
          <p class="welcome">ようこそ<span class="name">トレもん</span>さん！</p>
    ...
    <div class="bars-sp is-sp">
      <span class="bar"></span>
      <span class="bar menu__line--center"></span>
      <span class="bar menu__line--bottom"></span>
    </div>

    <div class="sp-menu is-sp">
      <div class="container">
        <ul class="pages-index flex">
          <li class="page">
            <a href="/" class="link">
              HOME
            </a>
  ...
  <main class="top-page">
    <section class="section-mv">
      <div class="container flex">
        ...
        <div class="slide">
          <img src="assets/img/top/mv-slide.png" alt="" class="img">
          <img src="assets/img/top/mv-slide.png" alt="" class="img">
          <img src="assets/img/top/mv-slide.png" alt="" class="img">
        </div>
    ...
    <section class="section-content">
      <div class="container">
        ...
        <div class="contents">
          <p class="amount">カテゴリー：すべて(5672)</p>
          <div class="content recommend" data-group="a">
