...
<head>
  ...
  <link href="../assets/css/pages/mypage.css" rel="stylesheet" media="all">

  <script src="../assets/js/jquery-3.4.1.min.js"></script>
  <script src="../assets/js/main.js"></script>
  <script src="../assets/js/pages/mypage-index.js"></script>
          ...
          <h1 class="title">会員登録情報</h1>
            <table class="table">
              <tr class="cell">
                ...
                <td class="data flex">
                  <input class="input" type="text" name="name" value="セルフ秋葉原店" readonly>
                  <button class="button" type="button">変更する</button>
                </td>
              </tr>
              <tr class="cell">
                <th class="label">名乗る称号</th>
                <td class="data flex">
                  <select class="select" id="status-select" name="status" readonly>
              ...
              <tr class="cell">
                ...
                <td class="data">
                  <input class="input" type="email" name="email" value="test8@asobox.ga" readonly>
                </td>
              </tr>
              <tr class="cell">
                ...
                <td class="data">
                  ...
                  <p class="radio-text-magazine yes">希望する</p>
                  <p class="radio-text-magazine no">希望しない</p>
                </td>
              </tr>
              <tr class="cell">
