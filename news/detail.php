...
<head>
  ...
  <link href="../assets/css/pages/news-detail.css" rel="stylesheet" media="all">
  ...
  <main class="news-detail-page">
    <section class="section-content">
      <div class="container">
        ...
        <h1 class="title">あのイーハトーヴォのすきとおった風、夏でも底に冷たさをもつ青いそら、うつくしい森で飾られたモリーオ市、郊外のぎらぎらひかる草の波</h1>
        <div class="img">
          <img src="../assets/img/news/dummy.png" alt="" class="item">
        </div>
